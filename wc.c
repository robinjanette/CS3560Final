...
*/
     ...
     /** @brief Print error message and exit with error status. If PERR is not 0, display current errno status. */
     static void
     ...
     /** @brief Print error message followed by errno status and exit
        with error code. */
     static void
     perrf (char *fmt, ...)
     {
     ...
     /** @brief Output counters for given file */
     void
     ...
     /** @brief Return true if C is a valid word constituent */
     static int
     ...
     /** @brief Get next word from the input stream. Return 0 on end
